<template>
  <div>
    ...
    <div class="h-full w-auto">
      <div class="container mx-auto max-w-7xl pt-32 pb-16 px-5">
        <div
          ...
          <div class="flex flex-col justify-between">
            <div>
              <h2 class="text-4xl font-semibold">Ingin membuat website ?<span class="text-dapurkode-logo-red block font-extrabold">Hubungi Kami !</span></h2>
            </div>
            <div class="mt-8 text-center">
              <svg id="ae37f038-3a9e-4b82-ad68-fc94ba16af2a" class="w-full" data-name="Layer 1"
                   viewBox="0 0 1096 574.74" xmlns="http://www.w3.org/2000/svg"
                   xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
                  <linearGradient id="eb6c86d6-45fa-49e0-9a60-1b0612516196" gradientUnits="userSpaceOnUse" x1="819.07"
                                  x2="819.07"
                                  y1="732.58" y2="560.46">
                  ...
                  <pattern id="ad310e25-2b04-44c8-bb7b-982389166780" data-name="New Pattern 3" height="49.48"
                           patternUnits="userSpaceOnUse" viewBox="0 0 36.88 49.48" width="36.88">
                  ...
                  <linearGradient id="a964f849-fa65-4178-8cc4-fb8fb10b3617" x1="462.91" x2="462.91"
                ...
                <g opacity="0.1">
                  ...
                  <path
                    ...
                    fill="#3f3d56" transform="translate(-52 -162.63)"/>
                ...
                <ellipse cx="548" cy="493.13" fill="#F28322" opacity="0.1" rx="548" ry="8.86"/>
                <ellipse cx="548" cy="565.88" fill="#F28322" opacity="0.1" rx="548" ry="8.86"/>
                <ellipse cx="548" cy="341.3" fill="#F28322" opacity="0.1" rx="548" ry="8.86"/>
                <ellipse cx="548" cy="417.21" fill="#F28322" opacity="0.1" rx="548" ry="8.86"/>
                <path
                  ...
                  fill="#F28322" opacity="0.1" transform="translate(-52 -162.63)"/>
                <path
                ...
                <path
                  ...
                  fill="url(#eb6c86d6-45fa-49e0-9a60-1b0612516196)" transform="translate(-52 -162.63)"/>
                <path
                  ...
                  fill="#be6f72" transform="translate(-52 -162.63)"/>
                <path
                  ...
                  fill="#ff6f61" transform="translate(-52 -162.63)"/>
                <path
                ...
                <g opacity="0.1">
                  ...
                  <path
                    d="M814.55,650.26s-9.94-.27-12.94-.81c0,.51,0,.81,0,.81-.78.78,13.76,1.18,13.76,1.18a1,1,0,0,1,.54.22C815.38,650.26,814.55,650.26,814.55,650.26Z"
                    fill="url(#ad310e25-2b04-44c8-bb7b-982389166780)" transform="translate(-52 -162.63)"/>
                  <path
                    d="M831.85,634.14c-.4-.39-.79-5.89-.79-5.89a1.69,1.69,0,0,1-.67.24c.14,1.66.41,4.21.67,4.47s2,10.22,1.57,14.94,0,4.71,0,4.71-12.75,1.87-15.84.62c0,.17.09.36.12.56.39,2.36,16.51,0,16.51,0s-.4,0,0-4.71S832.24,634.54,831.85,634.14Z"
                    fill="url(#ad310e25-2b04-44c8-bb7b-982389166780)" transform="translate(-52 -162.63)"/>
                </g>
                ...
                <path
                  ...
                  fill="url(#a964f849-fa65-4178-8cc4-fb8fb10b3617)" transform="translate(-52 -162.63)"/>
                <polygon fill="#2f2e41" points="415.35 438.25 417.53 438.69 424.96 449.68 421.69 450.12 415.35 438.25"/>
                <path
                  ...
                  fill="#fbbebe" transform="translate(-52 -162.63)"/>
                <path
                  ...
                  fill="#2f2e41" transform="translate(-52 -162.63)"/>
                <path
                ...
                <path
                  ...
                  fill="#e8e8f0" transform="translate(-52 -162.63)"/>
                <path
                ...
                <path
                  ...
                  fill="#f86d70" transform="translate(-52 -162.63)"/>
                <path
                ...
                <path
                  ...
                  opacity="0.1" transform="translate(-52 -162.63)"/>
                <ellipse cx="505.04" cy="584.74" fill="#fbbebe" rx="1.31"
                         ry="1.75"
          ...
          <div class="flex flex-col gap-10">
            <div class="text-center md:text-right">
              <h2 class="text-2xl font-Didact font-extrabold text-dapurkode-logo-orange">Alamat</h2>
              <p class="text-xl mt-5">Jalan Toya Anakan III No. 45, LC 8 <br>Singaraja - Bali</p>
            </div>
            <div class="text-center md:text-right">
              <h2 class="text-2xl font-Didact font-extrabold text-dapurkode-logo-orange">Email</h2>
              <p class="text-xl mt-5"><a href="mailto:dapurkode.idn@gmail.com">dapurkode.idn@gmail.com</a></p>
            </div>
            <div class="text-center md:text-right">
              <h2 class="text-2xl font-Didact font-extrabold text-dapurkode-logo-orange">Sosial Media</h2>
              <div class="block mt-5 text-5xl">
                <a title="Facebook Dapur Kode" class="hover:text-dapurkode-orange-500 duration-500" href="https://www.facebook.com/dapurkode.idn"><font-awesome-icon icon="facebook-square" class="inline mr-2"/></a>
                <a title="Instagram Dapur Kode" class="hover:text-dapurkode-orange-500 duration-500" href="https://instagram.com/dapurkode.idn"><font-awesome-icon icon="instagram" class="inline mr-2"/></a>
              </div>
            </div>
          </div>
        </div>
    ...
    return {
      ...
      link: [
        {rel: 'icon', type: 'image/x-icon', href: '/favicon.ico'},
        {
          hid: "canonical",
          rel: "canonical",
          href: "https://dapurkode.com/kontak-kami",
        },
      ]
    }
  },
